...
async function submitToHubSpot(assessmentData: AssessmentData, req: Request) {
  try {
    const portalId = process.env.HUBSPOT_PORTAL_ID || "8668897";
    const formGuid =
      process.env.HUBSPOT_FORM_ID || "cabcfef2-b350-4888-b5d8-c17fa8ed966c";
